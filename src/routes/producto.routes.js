...
// CRUD Productos
router.post("/productos", estaAutenticado, esAdmin, async (req, res) =>{
    const body = req.body;
...
router.put("/productos/:id", estaAutenticado, esAdmin, async (req, res) =>{
    const body = req.body;
    const id = req.params.id;
...
router.delete("/productos/:id", estaAutenticado, esAdmin, async (req, res) =>{
    const id = req.params.id;
